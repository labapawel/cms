...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Show/hide version in footer
    |--------------------------------------------------------------------------
    |
    | Add your custom text. If nullable - showing product SleepingOwl version.
    |
    */
    'show_version' => true,
    'version_text' => '',
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Sql search operator, for postgres use 'ILIKE'
    |--------------------------------------------------------------------------
    |
    | Case insensitive search for PostgreSQL if driver for query is psql
    |
    */
